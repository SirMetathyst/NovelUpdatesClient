...
// NovelType: Total(3)
const (
	NovelTypeLightNovel     = "2443"
	NovelTypePublishedNovel = "26874"
	NovelTypeWebNovel       = "2444"
)

var (
	NovelTypeToName = map[string]string{
...
var (
	NameToNovelType = map[string]string{
...
var (
	LanguageToName = map[string]string{
...
var (
	NameToLanguage = map[string]string{
